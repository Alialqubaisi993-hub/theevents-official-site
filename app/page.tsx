        ...
        <div>
          ...
          <h1 className="text-5xl font-black leading-tight md:text-7xl">
            {isAr
              ...
              : "Book your booth and join top events easily"}
          </h1>

          <p className="mt-6 max-w-xl text-xl leading-9 text-[#74687D]">
            {isAr
              ? "ثيفنت تجمع أصحاب المعارض، التجار، والزوار في منصة واحدة لإدارة الفعاليات، حجز البوثات، متابعة المشاركين، وإحصائيات الدخول."
              : "TheEvents connects organizers, exhibitors, and visitors in one platform for event management, booth booking, participant tracking, and visitor check-ins."}
          </p>
